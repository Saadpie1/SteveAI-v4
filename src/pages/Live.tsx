  ...
  return (
    <div id="live-page-wrapper" className="flex flex-col h-screen bg-black overflow-hidden relative">
      <div id="live-page-root" className="flex flex-col flex-1 lg:flex-row overflow-hidden relative pt-16">
        ...
        <div id="live-controls-panel" className="w-full lg:w-[380px] flex-none flex flex-col border-b lg:border-r lg:border-b-0 border-white/5 bg-zinc-950/50 backdrop-blur-3xl px-4 lg:px-6 py-4 lg:py-8 space-y-4 lg:space-y-6 overflow-y-auto z-10 scrollbar-hide">
          ...
          {error && (
              <div className="bg-red-500/10 border border-red-500/20 rounded-2xl p-4 space-y-3 animate-in fade-in slide-in-from-top-2 duration-300">
                  <div className="flex items-center gap-2">
                    <Radio className="w-3 h-3 text-red-500 animate-pulse" />
                    <span className="text-[10px] font-black text-red-500 uppercase tracking-widest">Neural Diagnostics</span>
                  </div>
                  ...
                  <p className="text-[9px] font-bold text-red-500/40 uppercase tracking-widest leading-tight">
                    Link failure detected. Please verify API configuration or network integrity.
                  </p>
              </div>
          )}
        ...
        {/* Main Content Area */}
        <div id="live-main-area" className="flex-1 relative flex flex-col min-h-0 bg-black overflow-y-auto scrollbar-hide">
            ...
            <div className="flex-1 flex flex-col items-center justify-center p-8 relative min-h-full">
                {(isThinking || isSearching) && (
                    <motion.div 
                      ...
                      className="absolute top-12 left-1/2 -translate-x-1/2 flex items-center gap-3 px-4 py-2 bg-white/5 border border-white/10 rounded-full backdrop-blur-xl z-20"
                    >
                ...
                <AnimatePresence>
                    {summary && (
                        <motion.div 
                            ...
                            className="max-w-md w-full bg-white/5 border border-white/10 p-6 rounded-3xl backdrop-blur-xl space-y-4 relative z-20"
                        >
                ...
                {!summary && !isConnected && !isConnecting && (
                  <div className="flex flex-col items-center gap-6 opacity-20">
                    ...
                    <div className="text-center space-y-2">
                      <h2 className="text-xl font-black uppercase tracking-[0.4em] text-white">Standby</h2>
                      <p className="text-[10px] font-bold text-white/40 uppercase tracking-[0.2em]">Ready for neural initiation</p>
                    </div>
                  </div>
                )}
            </div>
